...
public class AppLayerManagerPanel extends JPanel
{
    ...
    public AppLayerManagerPanel(final WorldWindow wwd)
    {
        ...
        this.layerNamesPanel.setBorder(BorderFactory.createEmptyBorder(3, 3, 3, 3));
        ...
        titlePanel.setBorder(
                new CompoundBorder(BorderFactory.createEmptyBorder(3, 3, 3, 3), new TitledBorder("Layers")));
